...
| --- | --- | --- | --- |
| **Recommended Setups:** | | | |
| <img src="SetupGuide/Images/ESP32-S3/ControllerSetup-ESP32-S3.jpg" width="200"> | ESP32-S3 | HID: Keyboard<br>Switch 1: Wired Controller<br>Switch 2: Wired Controller | [Guide (Windows)](SetupGuide/Controllers/Controller-ESP32-S3.md) |
