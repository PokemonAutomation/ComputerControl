...
| --- | --- | --- | --- | --- |
| <img src="SetupGuide/Images/ESP32/ControllerSetup-ESP32-WROOM.jpg" width="200"> | ESP32 | Switch 1: Wireless Pro Controller<br>Switch 1: Left Joycon<br>Switch 1: Right Joycon | 3 | [Windows](SetupGuide/Controllers/Controller-ESP32-WROOM.md)<br>[Mac](SetupGuide/Controllers/Controller-ESP32-WROOM-MacOS.md) |
...
| --- | --- | --- | --- | --- |
| Raspberry Pi Pico W<br>(USB Mode) | NS1: Wireless Pro Controller<br>NS1: Left Joycon<br>NS1: Right Joycon | Single: $8<br>Volume: $7 | 1 | Upgradable to UART mode.<br><br>Unresolved Bugs:<br>- [Issue 693](https://github.com/PokemonAutomation/Arduino-Source/issues/693) |
...
| Raspberry Pi Pico W<br>(UART Mode) | HID: Keyboard<br>NS1: Wired Controller<br>NS2: Wired Controller<br>NS1: Wireless Pro Controller<br>NS1: Left Joycon<br>NS1: Right Joycon | Single: $19<br>Volume: $10 | 5 | Exposed pins can be annoying.<br><br>Unresolved Bugs:<br>- [Issue 693](https://github.com/PokemonAutomation/Arduino-Source/issues/693) |
