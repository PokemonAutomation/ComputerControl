...
The Raspberry Pi Pico W (and Pico 2 W) is the easiest controller setup to do. It is the easiest wireless setup (easier than the ESP32) and is also capable of wired connection.
