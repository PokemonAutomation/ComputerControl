...
If you came here intending to run [AutoMaxLair](https://github.com/PokemonAutomation/AutoMaxLair) you must still go through here as the hardware setup is identical.
